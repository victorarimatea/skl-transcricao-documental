# Índice — skill-transcricao-documental
...
|---|---|---|
| [`SKILL.md`](./SKILL.md) | Pipeline completo: 7 etapas de extração, limpeza, estrutura jurídica, montagem, auto-verificação, nomenclatura e atualização do workflow | Para transcrever qualquer documento PDF |
...
|---|---|---|
| 0 | Leitura de contexto | Identifica documento, fase e necessidades especiais |
